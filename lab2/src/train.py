...
class Trainer:
    ...
    def _train_single_epoch(self):
        self.model.train()
        train_loss = 0
        tqdm_train_loader = tqdm(self.train_loader, desc='Training')
    ...
    def _validate(self):
        ...
        val_correct = 0
        val_total = 0
        tqdm_val_loader = tqdm(self.val_loader, desc='Validation')
    ...
    def test(self):
        ...
        test_correct = 0
        test_total = 0
        tqdm_test_loader = tqdm(self.test_loader, desc='Testing')
